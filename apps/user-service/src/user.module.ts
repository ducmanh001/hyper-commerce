...
import { USER_CACHE_PORT, USER_EVENT_PUBLISHER_PORT, PASSWORD_HASHER_PORT } from './application/ports/application.ports';

// Command handlers
import { RegisterUserHandler }  from './application/commands/register-user/register-user.handler';
import { UpdateProfileHandler } from './application/commands/update-profile/update-profile.handler';
import { FollowUserHandler, UnfollowUserHandler } from './application/commands/follow-user/follow-user.handler';

// Query handlers
import {
  GetUserProfileHandler, GetFollowersHandler, GetFollowingHandler,
  SearchUsersHandler, CheckUsernameAvailabilityHandler,
...
const COMMAND_HANDLERS = [RegisterUserHandler, UpdateProfileHandler, FollowUserHandler, UnfollowUserHandler];
const QUERY_HANDLERS   = [GetUserProfileHandler, GetFollowersHandler, GetFollowingHandler, SearchUsersHandler, CheckUsernameAvailabilityHandler];
...
@Module({
  ...
  providers: [
    ...
    UserService, FollowService, UserRepository, FollowRepository,
    CelebrityDetectorHelper, KafkaProducerService, RedisClientService,
  ],
  exports: [
